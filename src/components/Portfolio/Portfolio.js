            ...
            <div className="portfilio-piece-right">
              <div className="portfolio-description">
                <p>
                  ...
                  company. It provides a breakdown of the company finances, a to-do list, 
                  a weather station, an interface to dispatch a 
              ...
              <div className="portfolio-technologies">
                <p>
                  On the home page I use ChartJS for the finances, and I hit
                  the openweathermap.org API for the weather data. The driver
                  chart uses Material-UI and the dispatch tool keeps track of
                  the job data using React/Redux. An email is sent to the driver email on 
                  file using NodeMailer.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="portfolio-piece">
          ...
          <div className="portfolio-piece-body">
            ...
            <div className="portfilio-piece-right">
              <div className="portfolio-description">
                <p>
                  This is an app to help triathletes predict their race time. It uses sliders
                  to set their race distance and paces and it outputs the split for each individual 
                  event as well as a clock to let the athlete know how their overall time at each 
              ...
              <div className="portfolio-technologies">
                <p>
                  This app is built with HTML, CSS, and ReactJS. I have plans to further expand the 
                  functionaility by adding a backend to help keep track of workouts and personal bests.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="portfolio-piece">
          ...
          <div className="portfolio-piece-body">
            ...
            <div className="portfilio-piece-right">
              <div className="portfolio-description">
                <p>
                  This app allows the user to list a property for rent. It allows the user to specify the
                  relevant property information and then it recommends an appropriate rent amount.
                </p>
              </div>

              <div className="portfolio-technologies">
                <p>
                  HTML, CSS, ReactJS, React Redux, Express, Express Sessions, Node, and SQL were used in this app.
                  When the user creates an account, their username and password are stored in the database and a 
                  session is used to keep track of their property listings. Redux is used to keep track of the property information
                  as the user proceeds from page to page and then it's submitted to the database when it is complete. The properties are stored in the SQL database 
            ...
            <div className="portfilio-piece-right">
              <div className="portfolio-description">
                <p>
                  ...
                  progressed. It allows the user to login and save their results for future comparison.
                </p>
              </div>
